...
public class ArrayUtilities<T> {
    ...
    public ArrayUtilities(T[] arrContent) {
    ...
    public T[] removeDuplicatesHelper(T[] arr, T value) {
        ...
        T[] arr2 = (T[]) Array.newInstance(arrContent.getClass().getComponentType(), arr.length - countOfValue);
    ...
    /**
     * this is a helper method that helps determine the length of arr2 in the removeDuplicates() method above and also used in the methods above
